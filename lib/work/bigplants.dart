...
class Bigplants extends StatefulWidget {
  const Bigplants({super.key});

  @override
  State<Bigplants> createState() => _BigplantsState();
}

class _BigplantsState extends State<Bigplants> {
  @override
